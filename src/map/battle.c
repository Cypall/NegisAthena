		...
		if (!skill_num)
		{
			...
			switch( skill_num )
			{
				case CR_ACIDDEMONSTRATION:
					skillratio += battle_config.acid_demonstrtion_rate*skill_lv;
					break;
				case SM_BASH:
			...
			switch (skill_num) {
				case MO_EXTREMITYFIST:
					...
					//int bonus = battle_config.extremity_fist_bonus;
					ATK_ADD((battle_config.extremity_fist_bonus)*(250+150*skill_lv));
					break;
				case TK_DOWNKICK:
				case TK_STORMKICK:
				case TK_TURNKICK:
...
static const struct _battle_data {
	...
	{ "stat_bonus_lv",						&battle_config.stat_bonus_lv,						0,		0,		32765,			},
	{ "skill_point",						&battle_config.skill_point,						1,		0,		32765,			},
	{ "guild_allience",						&battle_config.guild_allience,					3,		0,		INT_MAX,		},
	{ "extremity_fist_bonus",				&battle_config.extremity_fist_bonus,			1,		0,		INT_MAX,		},
	{ "edp_rate",							&battle_config.edp_rate,						50,		0,		100,			},
	{ "acid_demonstrtion_rate",				&battle_config.acid_demonstrtion_rate,			25,		0,		100,			},
	{ "skull_id",							&battle_config.skull_id,						7420,	500,	INT_MAX,		},
