...
/* ///////////////////////////////////////*
 * / Delete Pet but NOT return to egg!  //*
 * ///////////////////////////////////////*/
int pet_del(struct map_session_data *sd)
{
	struct pet_data *pd;
	pd = sd->pd;
...
int pet_change(struct map_session_data *sd,struct s_pet *pet,int pet_id)
{
	/*struct block_list *bl;
	bl = &sd->pd->bl;
	nullpo_retr(1, sd);
